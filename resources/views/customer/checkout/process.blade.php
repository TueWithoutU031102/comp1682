...
<body>
  ...
  <div class="bg-base-200 min-h-screen pt-10">
    ...
    <div class="card bg-base-100 max-w-xl mx-auto w-full shadow">
      <div class="card-body">
        <h3 class="card-title">Payment process #69</h3>
        ...
        <div class="grid grid-cols-2">
          <p class="mt-3">
            Your total cost is: <span class="text-primary font-bold">{{ number_format(120000) }}</span>đ
          </p>
          <div>
            <button class="btn btn-success float-right">Pay with VNPay</button>
          </div>
        </div>
