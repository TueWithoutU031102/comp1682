...
<div class="min-h-screen grid place-content-center bg-base-200">
  ...
  <div>
    <div class="card max-w-xl bg-base-100 rounded-none shadow-lg">
      <div class="card-body">
        ...
        <div class="flex justify-center">
          <img class="aspect-square w-2/3" src="https://homepage.momocdn.net/blogscontents/momo-upload-api-220810110042-637957260425550228.webp">
        </div>
    ...
    <div class="mt-5">
      <button class="btn btn-sm btn-outline rounded-none">Go Back</button>
    </div>
  </div>
