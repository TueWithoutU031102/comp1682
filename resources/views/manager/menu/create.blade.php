    ...
    <form action="{{ route('manager.menu.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                @endif
                <h1 class="text-2xl font-bold">Add new dish</h1>
                ...
                <div class="form-control w-full max-w-xs w-full max-w-xs">
                    ...
                    <select name="type_id" value="{{ old('type_id') }}" class="select select-bordered w-full max-w-xs"
                        id="type">
                ...
                <div class="form-control w-full max-w-xs w-full max-w-xs">
                    ...
                    <select name="status" value="{{ old('status') }}" class="select select-bordered w-full max-w-xs"
                        id="statusMenu">
                ...
                <div class="form-control w-full max-w-xs w-full max-w-xs">
                    ...
                    <input type="text" class="input input-bordered w-full max-w-xs" value="{{ old('price') }}"
                        id="price" name="price">
                </div>
                ...
                <div class="form-control w-full max-w-xs w-full max-w-xs">
                    ...
                    <input type="text" class="input input-bordered w-full max-w-xs" value="{{ old('description') }}"
